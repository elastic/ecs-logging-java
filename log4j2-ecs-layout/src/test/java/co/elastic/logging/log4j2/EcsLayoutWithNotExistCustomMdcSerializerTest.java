...
public class EcsLayoutWithNotExistCustomMdcSerializerTest extends Log4j2EcsLayoutTest {
    ...
    void testAdditionalFieldsWithLookup() throws Exception {
        ...
        // Use the default implementation, and the text should be in lowercase
